...
window.addEventListener('DOMContentLoaded', () => {
    ...
    let authors = {
        CanhDo: {
            ...
            abstract: "With recent exponential investments from big companies and governments, there is a widespread belief that building a large-scale quantum computer is only a matter of time and effort. However, quantum computing is fundamentally different and counter-intuitive compared to classical computing, making it difficult to develop efficient algorithms and increasing the risk of programming errors. Therefore, ensuring the correctness of quantum programs becomes critical. This talk introduces QRAT, the first reachability analysis tool for quantum programs based on a state-of-the-art decision diagram developed in MQT Core for quantum computing. QRAT provides a novel framework for specifying quantum programs and their reachability properties and finding reachable states from some initial state as in the classical case. Experimental results demonstrate its practicality in verifying quantum programs. As reachability analysis is a fundamental task in model-checking algorithms, QRAT will serve as an essential step in developing a model checker for quantum programs in the future."
        },
        QuocTrinh: {
