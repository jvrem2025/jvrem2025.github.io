...
`,
        ...
        DoanDuy: {
            title: "Applying Deep Learning for Rainfall Prediction in Mountainous Area in Vietnam",
            abstract: `The advancement of information technology, especially in AI and IoT systems, has enabled efficient solutions for meteorology, particularly rainfall prediction. Real-time updates of environmental and weather data enhance the accuracy of rainfall forecasting systems, enabling timely warnings for high-risk areas. The mountainous regions of Vietnam frequently experience heavy rainfall due to storms and tropical depressions, leading to natural disasters such as floods and landslides. Accurate rainfall prediction plays a crucial role in disaster prevention and climate trend analysis.
This study utilizes real-time environmental and weather data and applies machine learning models to predict rainfall in high-risk landslide areas in Vietnam. An LSTM neural network forecasts rainfall for the next 24 hours based on past data. The predictions are continuously updated and stored on a server to support the development of early warning applications.`
        }
    };
})
